...
def main():
    ...
    print(f"Analysis Period: {analysis_df.index[0].date()} to {analysis_df.index[-1].date()}")
    print(f"Holding back test period from: {split_date.date()}\n")
    
    rsi_limits = [30, 40, 50, 60, 70, 80, 100]
